        ...
        <form method="POST" action="" class="my-10">
            <div class="flex flex-col space-y-5">
                <label for="email">
                    ...
                    <input id="resetemail" name="resetemail" type="email" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter email address">
                </label>
               
                <button name="resetpassword" class=" w-full py-3 font-medium text-white bg-purple-600 hover:bg-purple-500 rounded-lg border-purple-500 hover:shadow inline-flex space-x-2 items-center justify-center">
