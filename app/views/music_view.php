        ...
        <div class="w-full md:w-[75vw] lg:w-[80vw] h-full flex flex-col">
            ...
            <div class="flex justify-between">
                ...
                <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                    class="btn border-2 rounded-md bg-[#313866] text-white p-5 ">Add New Music</button>
            </div>

            <div class="flex h-[50vh]">
                <div class="border-2 rounded-md w-full h-fit p-1 m-5 ">
                    <div class="flex justify-between">

                        <p class="flex items-center"><img src="/paroly/public/../assets/images/paroly_logo.png" alt=""
                                width="100px"> Music Title</p>
                        <div class="flex items-center gap-10">
                            <h2>2:64</h2>
                            <button> <i class='bx bxs-microphone-alt text-2xl'></i>
                            </button>
                        </div>
                    </div>
                </div>
