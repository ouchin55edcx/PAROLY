        ...
        <div class="w-full md:w-[75vw] lg:w-[80vw] h-full flex flex-col">
            ...
            <div class="flex justify-between">
                ...
                <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                    class="btn border-2 rounded-md bg-[#313866] text-white p-5 "><i class='bx bx-plus'></i></button>
            </div>

            <div class="flex h-[50vh]">
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md h-fit w-full"
                    id="song">
                                ...
                                <tr>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            ...
                                            <img src="/paroly/public/../assets/images/addMusic/<?= $music->getImage() ?>"
                    ...
                    <form class="p-4 md:p-5" method="post" enctype="multipart/form-data">
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="w-full col-span-2">
                                ...
                                <input type="number" name="genre" id="email"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                    placeholder="Genre" required>
                            </div>

                            <button type="submit" name="submitMusic"
