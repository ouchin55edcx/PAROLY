                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="flex flex-wrap justify-around gap-10">
                            <?php foreach ($playlists as $playlist) : ?>
                                <a href="/paroly/public/Playlistcon/index/<?= $playlist->getId() ?>" class="card relative p-3 w-3/4 sm:w-1/3 md:w-1/4 lg:w-1/5 xl:w-1/6 mb-4 bg-slate-900 rounded-md hover:scale-105 duration-300 cursor-pointer hover:bg-slate-800">
